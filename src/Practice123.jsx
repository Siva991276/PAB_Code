  ...
  return (
    <section className="post-container text-start">
      {data.map((eachObj) => {
        ...
        return <Profile id={id} thumbnailUrl={thumbnailUrl} title={title} iurld={url} />;
      })}
    </section>
  );
}
...
const Profile = () => {
  return (
    <article className="profile-card">
      <img src="https://via.placeholder.com/150/92c952" alt="Something" />
      <h2 className="title">
        accusamus beatae ad facilis cum similique qui sunt
      </h2>
      <a href="https://via.placeholder.com/600/92c952" className="button">
        details
      </a>
    </article>
  );
